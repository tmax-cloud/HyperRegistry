...
//go:generate mockery --case snake --dir ../../pkg/request --name Manager --output ./request --outpkg request
//go:generate mockery --case snake --dir ../../pkg/request/dao --name DAO --output ./request/dao --outpkg dao
